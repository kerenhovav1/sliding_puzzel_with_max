...
public class Search {
     ...
     * the root in the first place is the board we initially get. this board doesn't have a parent,
     * and it doesn't have any previous action
    ...
    private Node getRoot(String boardString) {
        ...
        return new Node(new State(board), null, null);
    }
